...
def unpickle_from_file(fpath):
  ...
  builtins.TensorMetaClass = type(tf.__class__)
  builtins.JAX_MODE = False
  builtins.NUMPY_MODE = False

  setattr(builtins, '_wrap_method', deferred_tensor._wrap_method)
  setattr(builtins, 'TensorMetaClass', type(tf.Tensor).__class__)
